 ...
 */
final class Version20220627171345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INT NOT NULL, movie_id INT NOT NULL, user_id INT NOT NULL, positive BOOLEAN DEFAULT \'true\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5A108564A76ED3958F93B6FC ON vote (user_id, movie_id)');
        ...
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A1085648F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote DROP CONSTRAINT FK_5A1085648F93B6FC');
